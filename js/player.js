...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!npcInfoModal && document.body) {
    ...
    `;
    document.body.appendChild(npcInfoModal);
  ...
  function showItemPopup(item, qty) {
    ...
    const titleColor = colorMap[item.rarity] || "text-gray-100";
    ...
    popup.innerHTML = `
        ...
        <div class="flex-1 min-w-0">
            ...
            <p class="text-sm font-bold truncate ${titleColor}">${item.name} x${qty}</p>
        </div>
    `;
    achievementPopupContainer.appendChild(popup);
    requestAnimationFrame(() =>
  ...
  function renderInventory() {
    ...
    ownedItems.forEach(([itemId, qty]) => {
      ...
      const cardStyleMap = {
        ...
        green: "border-emerald-500/40 shadow-[0_0_10px_rgba(52,211,153,0.2)]",
        blue: "border-blue-500/50 shadow-[0_0_12px_rgba(96,165,250,0.3)]",
        indigo: "border-indigo-500/50 shadow-[0_0_14px_rgba(129,140,248,0.3)]",
        purple: "border-purple-500/60 shadow-[0_0_15px_rgba(192,132,252,0.4)]",
        orange: "border-orange-500/70 shadow-[0_0_20px_rgba(251,146,60,0.5)]",
        red: "red-border-dark shadow-[0_0_25px_rgba(248,113,113,0.6)]",
        gold: "gold-border-dark shadow-[0_0_30px_rgba(250,204,21,0.6)]",
        rainbow: "rainbow-border-dark shadow-[0_0_35px_rgba(255,255,255,0.5)]",
      };
      const cardStyle = cardStyleMap[itemData.rarity] || cardStyleMap.white;

      const itemCard = document.createElement("div");
      itemCard.className = `bg-gray-800 border p-5 rounded-xl flex flex-col justify-between hover:border-blue-400 transition-all duration-200 hover:-translate-y-1 hover:scale-105 active:scale-95 active:translate-y-0 hover:z-10 relative group ${cardStyle}`;
        ...
        <div class="flex items-start space-x-4 mb-5">
          ...
          <div class="flex-1 min-w-0">
            <div class="flex justify-between items-start gap-2 mb-1">
              <h3 class="text-lg font-bold ${titleColor} truncate">${itemData.name}</h3>
              ${typeBadge}
            </div>
